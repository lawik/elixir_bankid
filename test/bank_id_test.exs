defmodule BankIDTest do
  ...
  def poll_while_pending(order_ref) do
    case BankID.collect(order_ref) do
      %{"status" => "pending"} ->
        :timer.sleep(2000)
  ...
  test "auth + collect" do
    %{"orderRef" => order_ref} = BankID.auth("127.0.0.1", "198405157879")
    ...
    response = BankID.collect(order_ref)
  ...
  test "auth + collect - polling until success" do
    ...
    %{"orderRef" => order_ref} = BankID.auth("127.0.0.1", personal_id_number)
  ...
  test "sign" do
    response = BankID.sign("127.0.0.1", "signing test", nil, "198405157879")
  ...
  test "sign + collect" do
    %{"orderRef" => order_ref} = BankID.sign("127.0.0.1", "signing test", nil, "198405157879")
